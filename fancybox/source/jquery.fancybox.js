		...
		open: function (group, opts) {
			...
			$.each(group, function(i, element) {
				...
				if ($.type(element) === "object") {
                    ...
                    //Some hacks up in har
                    //Before we make this a jQuery object,
                    //let's get a reference to the child (this is so we 
                    //can use it later. Img alt will be the description, title will be 
                    //photog
                    var img_alt = element.firstChild.getAttribute('alt');
					if (element.nodeType) {
						element = $(element);
					}
